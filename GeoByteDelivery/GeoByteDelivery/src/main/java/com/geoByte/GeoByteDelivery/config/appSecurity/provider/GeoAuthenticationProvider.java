package com.geoByte.GeoByteDelivery.config.appSecurity.provider;
...
@Component
@AllArgsConstructor
public class GeoAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        final UserDetails userDetails = geoUserDetailsService.loadUserByUsername(requestEmail);
